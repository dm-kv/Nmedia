...
class PostRepositoryImpl @Inject constructor(
    ...
    private var _data: Flow<PagingData<Post>> = createPagingFlow()

    override val data: Flow<PagingData<Post>>
        get() = _data

    private fun createPagingFlow(): Flow<PagingData<Post>> = Pager(config = pagingConfig) {
        PostPagingSource(apiService)
    }.flow

    fun invalidatePagingSource() {
        _data = createPagingFlow()
    }
